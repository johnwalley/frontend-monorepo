...
import type { DealTicketQuery, DealTicketQuery_market } from './__generated__/DealTicketQuery';
...
export const DealTicketContainer = ({ marketId, children }: DealTicketContainerProps) => {
  ...
  return (
    <AsyncRenderer<DealTicketQuery> data={data} loading={loading} error={error}>
      {data && data.market ? (
        children ? children(data) : <DealTicketManager market={data.market} />
      ) : (
        <Splash>
