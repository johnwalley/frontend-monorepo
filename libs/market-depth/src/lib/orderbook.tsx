...
export const Orderbook = ({
  ...
  function scrollToMidPrice(midPrice: string) {
    if (scrollRef.current && rows) {
      ...
      console.log('scrollTo', midPrice, midPriceCenterScrollOffset);
  ...
  useEffect(() => {
    ...
    console.log('midPrice', bestStaticOfferPrice, bestStaticBidPrice);
    scrollToMidPrice(
      getPriceLevel(
